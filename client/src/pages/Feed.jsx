        ...
        <AnimatePresence>
          {feed?.users?.length > 0 ? (
                ...
                <div className="flex items-center justify-between gap-4 bg-black/50 backdrop-blur-sm p-4 rounded-xl shadow-lg">
                  ...
                  <div>
                    <button
                      ...
                      className="bg-pink-600 hover:bg-pink-700 text-white px-4 py-2 rounded-full text-sm shadow-md transition"
                    >
                      Connect
                    </button>
                  </div>
            ...
            <div className="text-center">
              <h1 className="text-3xl font-bold mb-4">No more users available 😔</h1>
